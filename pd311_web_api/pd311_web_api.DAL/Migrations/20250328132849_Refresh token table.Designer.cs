...
namespace pd311_web_api.DAL.Migrations
{
    ...
    [Migration("20250328132849_Refresh token table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pd311_web_api.DAL.Entities.Car", b =>
                {
            ...
            modelBuilder.Entity("pd311_web_api.DAL.Entities.CarImage", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("pd311_web_api.DAL.Entities.RefreshToken", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("pd311_web_api.DAL.Entities.CarImage", b =>
                {
                    b.HasOne("pd311_web_api.DAL.Entities.Car", "Car")
                        .WithMany("Images")
                        .HasForeignKey("CarId");
